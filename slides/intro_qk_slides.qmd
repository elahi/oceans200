...
With a partner, go to the [website](https://elahi.github.io/qk2e/), check out the [source code](https://github.com/elahi/qk2e), and work though the [Chapter 2 notes](chapter2.qmd) together.
